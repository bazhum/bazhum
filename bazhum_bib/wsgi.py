"""
WSGI config for bazhum_bib project.
...
os.environ["DJANGO_SETTINGS_MODULE"] = "bazhum_bib.settings"
#os.environ.setdefault("DJANGO_SETTINGS_MODULE", "bazhum_bib.settings")
