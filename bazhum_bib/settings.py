...
MEDIA_ROOT = '/srv/www/python/django-1.5-env/www/bazhum_bib/media/',
...
ROOT_URLCONF = 'bazhum_bib.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bazhum_bib.wsgi.application'
